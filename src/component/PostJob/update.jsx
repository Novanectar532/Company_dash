...
const Update = () => {
    ...
    useEffect(()=>{
        axios.get('http://localhost:5000/api/jobpost/'+id)
        .then(result=>{
            console.log(result)
    ...
    const update = (e)=>{
        e.preventDefault();
         axios.put('http://localhost:5000/api/jobpost/'+id, {
            jobTitle,
            employmentType,
            sallery,
            categories,
            ...
            <div className="flex flex-col md:flex-row md:justify-between gap-6">
              ...
              <div className="flex flex-col md:flex-row gap-x-5 md:w-2/3">
                <img
                  src={companyLogo}
                  alt="Company Logo"
                  className="mb-2 w-20  object-contain"
                />
                <div>
          ...
          {step < 3 ? (
            ...
            >
             ...
             <button
               type="submit"
               onClick={update}
               className="px-4 py-2 bg-green-600 text-white rounded-md mt-10"
             >
               Update
             </button>
          )}
